...
class EditEmployee extends ApplicationFrame implements ActionListener
{
	...
	JButton searchButton,cancelButton,editButton;
...
public void actionPerformed(ActionEvent e)
{
	...
	if(obj==editButton)
	{
		...
		Connect cc=new Connect();
		boolean result=cc.editEmployee(codeText.getText(),nameText.getText(),ageText.getText(),addressArea.getText(),genderCombo.getSelectedItem().toString(),phoneText.getText(),mobileText.getText(),emailText.getText(),departmentCombo.getSelectedItem().toString(),designationText.getText(),selectedRecord);
		if(result==true)

...
class AddEmployee extends ApplicationFrame implements ActionListener
{
...
public void actionPerformed(ActionEvent e)
{
	...
	if(obj==saveButton)
	{
		...
		boolean result=cc.insertEmployee(codeText.getText(),nameText.getText(),ageText.getText(),addressArea.getText(),genderCombo.getSelectedItem().toString(),phoneText.getText(),mobileText.getText(),emailText.getText(),departmentCombo.getSelectedItem().toString(),designationText.getText());
		if(result==true)
